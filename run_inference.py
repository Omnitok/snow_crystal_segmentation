...
def calculate_ferret(binary_image_path): # diameter of the smallest circle that encloses the particle 
                ...
                # EXTRACT THE CROPPED REGION INSIDE THE BOUNDING BOX
                    ...
                    if particle.shape[0] > 10 and particle.shape[1] > 10:  # LIMIT THE OBJECT SIZE
                      ...
                      ## calculate the aspect ratio of particles that is defined by the ratio of the 2 length of the bounding box that encapsulates the particle.
                        ...
                        aed = 2 * math.sqrt(np.count_nonzero(particle_mask == 1) / math.pi) * px_res
                        ...
                        # ferret
                        ferret = calculate_ferret(particle)
